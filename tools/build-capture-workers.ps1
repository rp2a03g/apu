...
$bundles = @(
    ...
    @{
        ...
        Files = @(
            ...
            'src\emulator\expansion\ym2203.js',
            'src\emulator\expansion\ym2608.js',
            'src\emulator\expansion\opl.js',
            'src\emulator\expansion\ga20.js',
            'src\emulator\expansion\segapcm.js',
            'src\emulator\expansion\c140.js',
            'src\emulator\expansion\c352.js',
            'src\emulator\expansion\okim6258.js',
            'src\emulator\expansion\qsound.js',
