 ...
 *   ★DPCM(E)の打点はここを通らない。E のノート番号は @DPCM 番号+24(src/convert/drumHits.js dpcmNote、
 *   ppmck準拠 2026-09-19)で、このレーン番号とは無関係。
 */
(function (global) {
  'use strict';
  ...
  // 「ロールにパッドが出てこない」ように見えていた(不具合報告、NCS91002 track0 で実測)。
