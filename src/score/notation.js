/*
 * 楽譜の表記モデル(作業計画「フェーズ外: 楽譜出力」段階2、2026-09-16)
 *
...
(function (global) {
  ...
  // gm: ノイズは周期が長い(低い=周期index が大きい。ノイズchの note は index 0-15 の直値、ppmck準拠 2026-09-18)
  //     ほうからキック(36)/スネア(38)/クローズドハイハット(42)、
  //     DPCM はサンプル番号(note - 24。Eの音符は @DPCM<n> の番号で、compiler.js DPCM_NOTE_BASE=24 を足した
  //     noteNumber で来る。ppmck準拠 2026-09-19)でキック/スネア/ハイハット/タム/クラッシュ/オープンハイハット/ロータム/ライドを回す。
